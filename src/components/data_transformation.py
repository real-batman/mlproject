...
class DataTransformation:
    # The DataTransformation class is responsible for handling the data transformation process, which includes creating a preprocessor object and applying it to the training and testing datasets.
